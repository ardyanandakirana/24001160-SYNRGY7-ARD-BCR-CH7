...
const Header: React.FC = () => {
  return (
    <header style={{ backgroundColor: '#f1f3ff', padding: 0 }}>
      <nav className="navbar navbar-expand-lg py-2 fixed-top" style={{ backgroundColor: '#f1f3ff' }}>
        <div className="container">
          ...
          <div className="offcanvas offcanvas-end w-50" tabIndex={-1} id="navbarOffcanvasLg" aria-labelledby="navbarOffcanvasLgLabel">
            ...
            <div className="offcanvas-body pt-0">
              <ul className="navbar-nav my-2 my-lg-0 ms-auto align-items-lg-center gap-3 gap-lg-0">
                <li className="nav-item"><a className="nav-link" href="#our-services">Our Services</a></li>
