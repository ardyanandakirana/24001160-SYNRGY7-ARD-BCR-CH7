...
const Testimonial: React.FC = () => {
  return (
    <section id="testimonial" className="text-center">
      <h1 data-aos="fade-down" data-aos-delay="100" data-aos-duration="500">Testimonial</h1>
      ...
      <div className="card d-flex flex-row gap-lg-4 border-0 owl-carousel owl-theme">
        <div className="card-item shadow-sm" data-aos="flip-left" data-aos-delay="300" data-aos-duration="500">
          <img src="./img/img_photo.png" alt="testi" style={{ width: '80px', height: '80px' }} />
          <div className="text-start ms-lg-5">
            <img src="./img/Rate.png" alt="rate" style={{ width: '80px', height: '16px' }} />
            <p>
        ...
        <div className="card-item shadow-sm" data-aos="flip-left" data-aos-delay="400" data-aos-duration="500">
          <img src="./img/img_photo2.png" alt="testi" style={{ width: '80px', height: '80px', borderRadius: '100px' }} />
          <div className="text-start ms-lg-5">
            <img src="./img/Rate.png" alt="rate" style={{ width: '80px', height: '16px' }} />
            <p>
              “Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod lorem ipsum dolor sit amet,
        ...
        <div className="card-item shadow-sm" data-aos="flip-left" data-aos-delay="500" data-aos-duration="500">
          <img src="./img/img_photo.png" alt="testi" style={{ width: '80px', height: '80px' }} />
          <div className="text-start ms-lg-5">
            <img src="./img/Rate.png" alt="rate" style={{ width: '80px', height: '16px' }} />
            <p>
