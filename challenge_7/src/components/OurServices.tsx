...
const OurServices: React.FC = () => {
  return (
    <section id="our-services" className="container">
      <div className="row">
        <div className="left col-lg-6 col-sm-12" data-aos="flip-left" data-aos-duration="500">
          <img src="./img/img_service.png" alt="Our Services" />
        </div>
        <div className="right col-lg-6 col-sm-12 p-0">
          <h1 className="pt-4" data-aos="fade-left" data-aos-delay="100">Best Car Rental for any kind of trip in (Lokasimu)!</h1>
          ...
          <div>
            <div className="list" data-aos="fade-left" data-aos-delay="300">
              <img src="./img/Group_53.png" alt="Check" />
